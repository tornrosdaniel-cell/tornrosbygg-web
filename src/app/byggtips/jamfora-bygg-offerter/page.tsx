...
export default function OfferterGuide() {
  return (
    <main>
      ...
      <section className="section"><div className="container grid gap-10 lg:grid-cols-2"><div><p className="eyebrow mb-4">Dokumentation</p><h2 className="heading-lg">Håll reda på besluten</h2></div><div><p className="body-lg">Törnros Bygg förespråkar att offert, ändringar och beslut dokumenteras under arbetet. Daniel Törnros står även bakom <a href="https://hantverkshjalpen.nu/" className="font-bold text-[var(--color-accent-dark)] underline underline-offset-4">Hantverkshjälpen.nu</a>, en separat plattform för att samla kommunikationen i byggprojekt. Du väljer själv hur du vill dokumentera ditt projekt.</p></div></div></section>
