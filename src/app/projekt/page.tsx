...
export const metadata: Metadata = {
  ...
  description: "Se exempel på Törnros Byggs renovering, tillbyggnad och nybyggnation i Solna och Danderyd.",
...
export default function ProjectsPage() {
  return (
    <main>
      <section className="container py-16 md:py-24"><div className="max-w-4xl"><p className="eyebrow mb-6">Projekt</p><h1 className="heading-xl">Utvalda byggprojekt</h1><p className="body-lg mt-8 max-w-3xl">Renovering, tillbyggnad och nybyggnation ser olika ut i praktiken. Här är exempel från arbeten i Solna och Danderyd.</p></div></section>
